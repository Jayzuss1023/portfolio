    ...
    <section id="experience" className="py-20 px-6">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-43xl md:text-5xl font-bold mb-4">
            Work Experience
          </h2>
        ...
        <div className="space-y-8">
          {experiences.map((exp) => (
            ...
            >
              {/* Timeline Dot */}
              <div className="absolute -left-2.25 top-0 w-4 h-4 bg-primary border-4 border-background rounded-full" />
                  ...
                  <div className="mb-4">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-muted-foreground text-xs @md/card:text-sm">
                      {exp.achievements.map((achievement, idx) => (
                        <li key={`${exp.company}-${idx}`}>{achievement}</li>
                      ))}
                    </ul>
                  </div>
                )}
                    ...
                    {exp.technologies.map((tech, techIdx) => {
                      ...
                      return techData?.name ? (
                        <span
                          ...
                          className="px-2 py-0.5 @md/card:px-3 @md/card:py-1 text-xs bg-primary/10 rounded-full text-primary"
                        >
                          {techData.name}
                        </span>
                      ) : null;
