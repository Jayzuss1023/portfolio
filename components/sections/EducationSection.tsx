...
export async function EducationSection() {
  ...
  return (
    <section
      id="education"
      className="relative py-20 px-6 bg-muted/20 overflow-hidden"
    >
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {education.map((edu) => (
            ...
            >
              {/* Accent gradient bar */}
              <div className="absolute top-0 left-0 right-0 bg-linear-to-r from-primary via-primary/60 to-primary/30 h-1 z-10" />
              ...
              <div className="relative z-10 p-6">
                ...
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-lg font-medium text-primary mb-`">
                      {edu.institution}
                    </p>
                    {edu.fieldOfStudy && (
                ...
                {/* Description */}
                {edu.description && (
                  <p className="text-sm text-muted-foreground mb-4 lime-clamp-3">
                    {edu.description}
                  </p>
                )}
                ...
                {edu.achievements && edu.achievements.length > 0 && (
                  <div className="mb-4 p-3 rounded-lg bg-muted/50">
                    <h4 className="text-sm font-semibold mb-2 flex items-center gap-2">
                      <IconAward className="w-4 h-4 trext-primary" />
                      Achievements & Honors
                    </h4>
