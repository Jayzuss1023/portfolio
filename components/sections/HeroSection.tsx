...
async function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div id="home" className="relative z-10 container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-8 @lg:gap-12 items-center">
            ...
            <div className="@container/hero space-y-4 @md/hero:space-y-6">
              ...
              profile.headlineAnimatedWords.length > 0 ? (
                ...
                <p className="text-cl @md/hero:texst-2xl @mlghero:text-3xl text-muted-foreground font-medium">
                  {profile.headline}
                </p>
              )}
                ...
                <div className="flex flex-wrap gap-3 @md/hero:gap-4 pt-4">
                  {profile.socialLinks.github && (
                    <Link
                      ...
                      className="px-4 py-2 @md/hero:px-6 @md:hero:py-3 hover:bg-accent border rouneded-lg transition-colors text-sm @md/hero:text-base"
                    >
                      Github
                    </Link>
                  )}
